...
describe('simulation reducer', () => {
    ...
    describe('internal updates', () => {
        beforeEach(() => {
            ...
            s1 = store.getPresentState().simulation;
        ...
        it('target time update', () => {
            ...
            let s2 = store.actions.simulation.setTargetTime(t2).getPresentState().simulation;
        ...
        it('increment target time', () => {
            let s2 = store.actions.simulation.incrementTargetTime().getPresentState().simulation;
            expect(s2.forward).toBe(true);
        ...
        it('update current time', () => {
            ...
            let s2 = store.actions.simulation.updateCurrentTime().getPresentState().simulation;
